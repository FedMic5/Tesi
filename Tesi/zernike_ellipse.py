...
HOW TO USE IT::
    ...
    coeff, mat = zernike_ellipse.zernikeFit(img, zernike_index_vector)
    surf_image = zernike_ellipse.zernikeSurface(img, coeff, mat)
"""

### Libraries

import numpy as np
from Tesi import geo1
...
def zernikeFit(img, zernike_index_vector):
    ...
    x, y, r, xx, yy = geo1.qpupil_ellipse(img)
    mm = (mask==1)
    coeff = _surf_fit(xx[mm], yy[mm], img[mm], zernike_index_vector)
